...
TEST_F(GpuPerformanceModelBaseTest, CalculatePeakFP16FlopsPerNsH100) {
  se::DeviceDescription h100_device_info =
      TestGpuDeviceInfo::RTXH100SXMDeviceInfo();
  int64_t flops_per_ns = GpuPerformanceModelBase::CalculatePeakMatrixFlopsPerNs(
...
TEST_F(GpuPerformanceModelBaseTest, CalculatePeakFP64FlopsPerNsH100) {
  se::DeviceDescription h100_device_info =
      TestGpuDeviceInfo::RTXH100SXMDeviceInfo();
  int64_t flops_per_ns = GpuPerformanceModelBase::CalculatePeakMatrixFlopsPerNs(
